...
-- Enable pgcrypto for bcrypt hashing during seeding (Neon supports this extension)
...
-- 6) Users (Use real bcrypt hashes generated by pgcrypto)
-- All seeded users use the password 'test1234'
INSERT INTO Users(customer_id, username, password_hash, role)
SELECT NULL, 'admin', crypt('test1234', gen_salt('bf', 12)), 'admin';

INSERT INTO Users(customer_id, username, password_hash, role)
SELECT c.customer_id, 'pharma1', crypt('test1234', gen_salt('bf', 12)), 'customer'
FROM Customers c WHERE c.name = 'PharmEasy Pharmacy';

INSERT INTO Users(customer_id, username, password_hash, role)
SELECT c.customer_id, 'hosp1', crypt('test1234', gen_salt('bf', 12)), 'customer'
FROM Customers c WHERE c.name = 'City Hospital';
